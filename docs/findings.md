...
### Weighting Robustness (Renter-Prevalence Weights)
...
Full per-metro figures (`rq4_<metro>_repricing_consumed.png`) and the same table, machine-written, live in each `data/processed/<METRO>/rq4_summary_<METRO>.md`.
